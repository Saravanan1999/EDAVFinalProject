...
The reason why NVDA tops the list is because of their rapid growth in such a short time and they do not seem to be stopping any time soon. So this involves a lot of risks especially with the current market trends. So this stock although gives you more profit, has immense risk associated with it. GS has a lot of reliance on investment banking and trading as mentioned above which is sensitive to market volatility. So during a bull market, they are very strong due to their expertise in asset management, trading, etc. This is why there was a huge dip in their drawdown in the late 2022. WFC is risky because of their fluctuating trends and inherent issues with their reputation which occurred in 2016 ([Source](https://thefinancialbrand.com/news/bank-culture/how-hard-did-cfpb-hit-wells-in-its-reputation-versus-its-wallet-157614/)), so this could be why their stocks had such a volatility.

### Future Scope

A direct implication of this project can be stock price prediction using advanced machine learning techniques.

Then we could also categorize each stock as undervalued, fairly valued or overvalued based on metrics like EBITDA, P/E ratio etc. This helps in identifying anomalies in the market, investment opportunities etc.

We could also expand this to global markets and include international stocks as well.
...
These are things that we wanted to do but we weren’t able to due to time and data constraints. Categorize each stock based on their market capitalisation as Large-Cap, Mid-Cap or Small-Cap. THis helps in analysing risks, performance trends and helps investors align their portfolios with their tolerance for risk. We could use Stacked Bar Chart to visualise this. Find short-term and long-term profit stocks.

### Learnings

We learnt a lot about the behaviour of each stock and how deeply it can get affected by something as simple as protests or riots or as huge as the pandemic. This increased our existing knowledge about stocks and how to conduct technical analysis to find out which stock to invest in. We hope that you were able to take away these key aspects of the project as we did.
