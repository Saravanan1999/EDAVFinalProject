...
2. 
```{r}
aapl = read.csv("C:\\Users\\bavna\\OneDrive\\Documents\\EDAVFinalProject\\Datasets\\TECH\\AAPL Historical data.csv")
head(aapl)
goog = read.csv("C:\\Users\\bavna\\OneDrive\\Documents\\EDAVFinalProject\\Datasets\\TECH\\GOOG class C Historical data.csv")
head(goog)
meta = read.csv("C:\\Users\\bavna\\OneDrive\\Documents\\EDAVFinalProject\\Datasets\\TECH\\META CLASS A Historical data.csv")
head(meta)
msft = read.csv("C:\\Users\\bavna\\OneDrive\\Documents\\EDAVFinalProject\\Datasets\\TECH\\MSFT Historical data.csv")
head(msft)
nvda = read.csv("C:\\Users\\bavna\\OneDrive\\Documents\\EDAVFinalProject\\Datasets\\TECH\\NVDA historical data.csv")
head(nvda)
#missing data
...
```
There are 2 of types visualizations we have done to depict the missing values in the data.One using regular ggplot and the other using the naniar package.As seen from the graphs, there are no missing values.This trend can be attributed to the fact that all stocks have a price and they are updated accordingly